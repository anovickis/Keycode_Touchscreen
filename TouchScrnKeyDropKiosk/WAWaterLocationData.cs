...
{
    class WAWaterLocationData : LocationData
    {
        ...
        public WAWaterLocationData():base()
        {
        ...
        {
            LocationTransactionData fakedata = new WAWaterTransactionData();
        ...
        public class WAWaterTransactionData : LocationData.LocationTransactionData
        {
            ...
            public WAWaterTransactionData(): base()
            {
            ...
            {
                WAWaterTransactionData copy = new WAWaterTransactionData();
